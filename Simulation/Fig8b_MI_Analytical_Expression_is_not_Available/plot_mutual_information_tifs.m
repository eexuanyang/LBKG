...
figure
plot((0:25),MIs_arr_tifs_bit,'-^',LineWidth=LineWidth_val, MarkerSize=MarkerSize_val);
hold on 
plot((0:25),Gaussian_estimate_tifs_bit,'-s',LineWidth=LineWidth_val, MarkerSize=MarkerSize_val);
% yticks([0:2:10])
xlabel({"SNR"; '(a)'})
