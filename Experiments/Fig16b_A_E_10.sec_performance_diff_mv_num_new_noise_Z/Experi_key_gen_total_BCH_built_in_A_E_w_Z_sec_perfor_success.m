...
mv_arr = [25 75 150 200 300];
seg_num = 100;
for mv_idx = 1:length(mv_arr)
    mv_len = mv_arr(mv_idx);
    ...
    save(['key_fdd_norm_sort_A_E_kdr_zz_mv' num2str(mv_len) '.mat'],'key_fdd_norm_sort_A_E_kdr_zz')
    save(['key_fdd_norm_sort_A_E_kgr_zz_mv' num2str(mv_len) '.mat'],'key_fdd_norm_sort_A_E_kgr_zz')
    toc
end
