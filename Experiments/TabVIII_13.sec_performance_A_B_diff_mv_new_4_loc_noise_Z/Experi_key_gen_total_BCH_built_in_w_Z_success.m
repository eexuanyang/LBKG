...
for mv_idx = 1:length(mv_arr)
    ...
    for seed_z = seed_z_arr
        ...
        dlmwrite(['key_arr_fdd_mv' num2str(mv_len) '_seed' num2str(seed_z) '.out'], key_arr_fdd_a_norm_sort_ds_bit_disc_final, ' ');
    
    end

    save(['key_fdd_norm_sort_kdr_zz_mv' num2str(mv_len) '.mat'],'key_fdd_norm_sort_kdr_zz')
    save(['key_fdd_norm_sort_kgr_zz_mv' num2str(mv_len) '.mat'],'key_fdd_norm_sort_kgr_zz')
