...
for seg_idx = 1:length(seg_arr)
    ...
    save(['key_fdd_norm_sort_A_E_kdr_zz_seg' num2str(seg_num) '.mat'],'key_fdd_norm_sort_A_E_kdr_zz')
    save(['key_fdd_norm_sort_A_E_kgr_zz_seg' num2str(seg_num) '.mat'],'key_fdd_norm_sort_A_E_kgr_zz')
    toc
end
...
mean(key_fdd_norm_sort_A_E_kdr_zz)