...
% %                             hold on
        ...
        dlmwrite(['key_arr_fdd_range' num2str(range_idx) '_seed' num2str(seed_z) '.out'], key_arr_fdd_a_norm_sort_ds_bit_disc_final, ' ');
    
    end

    save(['key_fdd_norm_sort_kdr_zz_range' num2str(range_idx) '.mat'],'key_fdd_norm_sort_kdr_zz')
    save(['key_fdd_norm_sort_kgr_zz_range' num2str(range_idx) '.mat'],'key_fdd_norm_sort_kgr_zz')
