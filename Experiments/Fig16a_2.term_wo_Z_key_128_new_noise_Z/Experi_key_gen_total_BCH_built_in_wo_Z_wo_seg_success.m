...
key_fdd_norm_sort_kdr_wo_Z_wo_seg = 1 - length(find((key_arr_fdd_a_norm_sort_ds_bit_disc_final == key_arr_fdd_b_norm_sort_ds_bit_disc_final)))/length(key_arr_fdd_a_norm_sort_ds_bit_disc_final);
key_fdd_norm_sort_kgr_wo_Z_wo_seg = 2*length(find((key_arr_fdd_a_norm_sort_ds_bit_disc_final == key_arr_fdd_b_norm_sort_ds_bit_disc_final)))/length(key_arr_fdd_a_norm_sort_ds_bit_disc_final);

dlmwrite('key_arr_fdd_wo_Z_wo_seg.out', key_arr_fdd_a_norm_sort_ds_bit_disc_final, ' ');

save('key_fdd_norm_sort_kdr_wo_Z_wo_seg.mat','key_fdd_norm_sort_kdr_wo_Z_wo_seg')
save('key_fdd_norm_sort_kgr_wo_Z_wo_seg.mat','key_fdd_norm_sort_kgr_wo_Z_wo_seg')
