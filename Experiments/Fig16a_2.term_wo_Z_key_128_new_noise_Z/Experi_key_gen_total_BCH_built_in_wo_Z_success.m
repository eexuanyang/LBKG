...
key_fdd_norm_sort_kdr_wo_Z = 1 - length(find((key_arr_fdd_a_norm_sort_ds_bit_disc_final == key_arr_fdd_b_norm_sort_ds_bit_disc_final)))/length(key_arr_fdd_a_norm_sort_ds_bit_disc_final);
key_fdd_norm_sort_kgr_wo_Z = 2*length(find((key_arr_fdd_a_norm_sort_ds_bit_disc_final == key_arr_fdd_b_norm_sort_ds_bit_disc_final)))/length(key_arr_fdd_a_norm_sort_ds_bit_disc_final);

dlmwrite('key_arr_fdd_wo_Z.out', key_arr_fdd_a_norm_sort_ds_bit_disc_final, ' ');

save('key_fdd_norm_sort_kdr_wo_Z.mat','key_fdd_norm_sort_kdr_wo_Z')
save('key_fdd_norm_sort_kgr_wo_Z.mat','key_fdd_norm_sort_kgr_wo_Z')
