...
seed_z_arr = 1:10;
% key_fdd_norm_sort_kdr = zeros(1,length(seed_z_arr));
% key_fdd_norm_sort_kgr = zeros(1,length(seed_z_arr));
...
%     key_arr_b_bit_vec_discard = key_arr_b_bit_vec_discard_ori;

key_tdd_norm_sort_kdr = 1 - length(find((key_arr_fdd_a_norm_sort_ds_bit_disc_final == key_arr_fdd_b_norm_sort_ds_bit_disc_final)))/length(key_arr_fdd_a_norm_sort_ds_bit_disc_final);
key_tdd_norm_sort_kgr = 2*length(find((key_arr_fdd_a_norm_sort_ds_bit_disc_final == key_arr_fdd_b_norm_sort_ds_bit_disc_final)))/length(key_arr_fdd_a_norm_sort_ds_bit_disc_final);

dlmwrite(['key_arr_tdd.out'], key_arr_fdd_a_norm_sort_ds_bit_disc_final, ' ');

save('key_tdd_norm_sort_kdr.mat','key_tdd_norm_sort_kdr')
save('key_tdd_norm_sort_kgr.mat','key_tdd_norm_sort_kgr')
